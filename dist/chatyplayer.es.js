...
function Ee(n, t, i) {
  ...
  const c = () => {
    ...
    var u, h;
    if (!(!c() && l.key.toLowerCase() !== "t") && !(l.repeat && (l.key === " " || l.key === "m" || l.key === "f" || l.key === "t")))
      switch (l.key.toLowerCase()) {
        ...
        case "arrowup":
          l.preventDefault();
          const v = Math.min(1, r.volume + ee);
          n.setVolume(v), r.muted = !1, i == null || i.set("volume", v), i == null || i.set("muted", !1);
          break;
        case "arrowdown":
          l.preventDefault();
          const m = Math.max(0, r.volume - ee);
          n.setVolume(m), r.muted = !1, i == null || i.set("volume", m);
          break;
        case "m":
